...
import com.yanghu.manage.hander.MyAuthenctiationFailureHandler;
import com.yanghu.manage.hander.MyAuthenctiationSuccessHandler;
import com.yanghu.manage.security.MyUserDetailsService;
...
/**
 * SpringSecurity的配置类
 * 进行 用户授权，配置放行，登入登出，处理回调，单点登录，跨域处理，
 */
@Component
@EnableWebSecurity
